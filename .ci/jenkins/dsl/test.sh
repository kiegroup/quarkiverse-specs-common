...
export DSL_DEFAULT_MAIN_CONFIG_FILE_REPO="${git_author}"/quarkiverse-specs-common
export DSL_DEFAULT_FALLBACK_MAIN_CONFIG_FILE_REPO=kiegroup/quarkiverse-specs-common
export DSL_DEFAULT_MAIN_CONFIG_FILE_PATH=.ci/jenkins/config/main.yaml
export DSL_DEFAULT_BRANCH_CONFIG_FILE_REPO="${git_author}"/quarkiverse-specs-common
